...
DATASETS = {
	...
	'celeba_encode': {
		'transforms': transforms_config.EncodeTransforms,
		'train_source_root': dataset_paths['celeba_train'], #celeba_train
		'train_target_root': dataset_paths['celeba_train'], #celeba_train
		'test_source_root': dataset_paths['celeba_test'], #celeba_test
		'test_target_root': dataset_paths['celeba_test'], #celeba_test
	},
	'ffhq_frontalize': {
