...
class LatentEditor(object):
    ...
    def apply_ganspace(self, latent, ganspace_pca, edit_directions, alpha=1):
        edit_latents = ganspace.edit(latent, ganspace_pca, edit_directions, alpha)
        return self._latents_to_image(edit_latents, resize=True)
    ...
    def _latents_to_image(self, latents, resize=False):
        with torch.no_grad():
